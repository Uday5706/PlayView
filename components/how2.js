...
export default function Home() {
  ...
  return (
    <div>
      ...
      <Navbar />
      <div className="play h-[calc(100vh-70px)] flex flex-col items-center">
        <div className="flex items-center h-[45px] w-[90%] gap-2 my-4 flex-wrap">
          <div onClick={handleFetch} className="flex h-full aspect-square rounded-full items-center justify-center bg-indigo-400">
             <Search className="w-5 h-5 text-white" />
              ...
              />
              <button onClick={handleFetch} className="bg-indigo-400 text-white px-8 py-2 h-full rounded ">
                Load
              </button>
            </div>
        <div className="main lg:flex gap-2 h-[80%] w-[90%] mx-auto">
          <div className="video rounded-lg bg-black h-full lg:w-[65%]">
            <div className="w-full h-full">
              <div id="youtube-player" className="w-full h-full aspect-video rounded-xl"></div>
            </div>
          </div>
          <div className="playlist rounded-lg playlist-scroll w-[100%] lg:w-[35%] bg-gray-700">
            ...
            <div className="list">
              <div className="flex flex-col overflow-y-auto h-[calc(550px)]">
                {videos.map(v => (
                  <div
                    key={v.id}
